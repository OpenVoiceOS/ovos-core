...
from ovos_intent_plugin_padaos import PadaosExtractor
...
class TestPadaos(unittest.TestCase):
    ...
    def test_single_intent(self):
        ...
        def test_intent(sent, intent, entities=None, min_conf=0.0):
            ...
            self.assertEqual(res["intent_engine"], "padaos")
    ...
    def test_main_secondary_intent(self):
        ...
        def test_intent(sent, intent, entities=None):
            ...
            if len(res) == 1:
                first = res[0]
                second = {"intent_type": "unknown", "intent_engine": "padaos"}
            else:
                first, second = res[0], res[1]

            self.assertEqual(first["intent_engine"], "padaos")
            self.assertEqual(second["intent_engine"], "padaos")
